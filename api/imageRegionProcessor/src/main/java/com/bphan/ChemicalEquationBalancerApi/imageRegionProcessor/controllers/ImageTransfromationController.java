...
public class ImageTransfromationController {
  ...
  public ImageTransformerResponse rotateImage(
  ...
  public ImageTransformerResponse scaleImage(
      @RequestParam(value = "rid", required = true) String requestId,
    ...
    BufferedImage scaledImage =
        imageOperations.scale(image, scaleOriginX, scaleOriginY, scaleWidth, scaleHeight);
