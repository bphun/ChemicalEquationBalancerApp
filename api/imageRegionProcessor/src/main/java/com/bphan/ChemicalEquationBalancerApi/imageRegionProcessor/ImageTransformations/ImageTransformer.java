...
public class ImageTransformer {
  ...
  public ImageTransformerResponse rotate(
      String requestId, BufferedImage image, String newFilename, double radians) {
  ...
  public ImageTransformerResponse scale(
      String requestId,
      BufferedImage image,
      String newFilename,
      int scaleWidth,
    ...
    BufferedImage scaledImage =
        this.imageOperations.scale(image, scaleOriginX, scaleOriginY, scaleWidth, scaleHeight);
    String fileName = newFilename != null ? newFilename : requestId;
