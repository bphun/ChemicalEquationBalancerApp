...
public class ImageProcessorRequestRepository {
    ...
    public void uploadRequestInfo(String requestId, String base64EncodedImage, long requestStartTime, long requestEndTime) {
        jdbcTemplate.update("INSERT INTO ImageProcessorRequestInfo"
        + "(id, imageString, gcpRequestStartTimeMs, gcpRequestEndTimeMs)"
        + "VALUES (?, ?, ?, ?)",
