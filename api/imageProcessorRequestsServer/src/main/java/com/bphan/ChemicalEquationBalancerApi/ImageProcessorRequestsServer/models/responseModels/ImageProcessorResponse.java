package com.bphan.ChemicalEquationBalancerApi.ImageProcessorRequestsServer.models.responseModels;
...
enum Type {
  ...
  public static Type forValue(String value) throws IOException {
    if (value.equals("EOL_SURE_SPACE")) return EOL_SURE_SPACE;
    if (value.equals("LINE_BREAK")) return LINE_BREAK;
    if (value.equals("SPACE")) return SPACE;
