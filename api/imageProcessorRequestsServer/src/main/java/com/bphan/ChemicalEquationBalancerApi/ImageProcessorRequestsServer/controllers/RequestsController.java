...
public class RequestsController {
  ...
  @CrossOrigin(origins = frontendHostname)
  @GetMapping("/info")
  public StoredRequestInfo getStoredRequestInfoList(
  ...
  public ApiResponse updateValue(
      @RequestParam(value = "rid", required = true) String id,
    ...
    switch (valueId) {
      case "userInputtedChemicalEquationString":
        responseBody =
            imageProcessorRequestRepository.updateUserInputtedChemicalEquationString(id, value);
        break;
      case "verifiedChemicalEquationString":
        responseBody =
            imageProcessorRequestRepository.updateVerifiedChemicalEquationString(id, value);
        break;
      case "gcpIdentifiedChemicalEquationString":
        responseBody =
            imageProcessorRequestRepository.updateGcpIdentifiedChemicalEquationString(id, value);
        break;
      case "onDeviceImageProcessStartTime":
        responseBody =
            imageProcessorRequestRepository.updateOnDeviceImageProcessStartTime(id, value);
        break;
      ...
      case "onDeviceImageProcessDeviceName":
        responseBody =
            imageProcessorRequestRepository.updateOnDeviceImageProcessDeviceName(id, value);
        break;
      case "labelingStatus":
